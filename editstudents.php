    ...
    <?php
        ...
        if(isset($_POST['updateEnrollments'])){
            ...
            $course =$_POST['course'];
             ...
             //SQL to update
             $updateStudent = mysqli_query($conn, "UPDATE enrollments SET name='$name', reg_number='$regnumber', 
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="editstudents.php?id=<?php echo $studentId ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <button type="update" class="btn btn-success" name="updateEnrollments">Update Records</button>
                                    </div>
                                </div>
                            </form>
                        </div>
